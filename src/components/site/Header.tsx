    ...
    <header className="sticky top-0 z-30 border-b border-border bg-white/95 backdrop-blur">
      ...
      <div className="mx-auto flex max-w-6xl items-center justify-between gap-3 px-4 py-3">
        <Link to="/" className="flex min-w-0 items-center gap-2">
          <span className="grid h-10 w-10 shrink-0 place-items-center rounded-md bg-primary text-primary-foreground font-black">
            S
          </span>
          <span className="min-w-0">
            ...
            <span className="block truncate text-[11px] text-muted-foreground sm:text-xs">
              Independent Repair Specialists · Mumbai
            </span>
          </span>
        </Link>
