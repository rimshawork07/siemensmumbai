...
const ZONES = [
  ...
  "Central Mumbai",
  "Western Mumbai",
  "Eastern Mumbai (Powai, Bhandup, Mulund)",
];
    ...
    <footer className="mt-10 border-t border-border bg-muted/50 pb-24 pt-8 md:pb-8">
      <div className="mx-auto grid max-w-6xl gap-6 px-4 md:grid-cols-4">
        <div>
          ...
          <p className="mt-2 text-sm text-muted-foreground">
            Independent Siemens washing machine repair specialists serving Mumbai with same-day
            service and 1+ year parts warranty.
          </p>
      ...
      <div className="mx-auto mt-6 max-w-6xl px-4">
        <p className="rounded-lg border border-border bg-white p-3 text-xs leading-relaxed text-muted-foreground">
          <strong className="text-foreground">Disclaimer:</strong> We are an independent Siemens
          washing machine repair service provider and are not affiliated with, authorized by,
          endorsed by, or an official service center of Siemens. All trademarks and brand names
          belong to their respective owners and are used solely for identification purposes.
        </p>
