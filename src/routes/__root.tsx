  ...
  head: () => ({
    meta: [
      ...
      { title: "Siemens Washing Machine Repair Service in Mumbai | Same Day Service" },
      {
        name: "description",
        content:
          "Expert independent Siemens washing machine repair service in Mumbai. Same-day service, genuine spare parts, experienced technicians, 1-year parts warranty. Call now.",
      },
